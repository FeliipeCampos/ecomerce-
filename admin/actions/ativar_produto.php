...
try {
    // Prepara a query para atualizar o status do produto para 'ativo'
    ...
    if ($stmt->rowCount()) {
        // Se o produto foi ativado com sucesso, redireciona para a página de visualização de produtos
        header("Location: ../visualizar_produtos.php");
        exit;
    } else {
        echo "Produto não encontrado ou já ativado.";
    }
} catch (PDOException $e) {
    echo "Erro ao ativar produto: " . $e->getMessage();
}
?>
